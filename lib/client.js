  ...
  factory: function () {
    ...
    function apply(ctx) {
      var CSS = [
        ...
        '  /* thicker pinned header: taller hit area + tight theme-aware drop shadow (no glow, no hard line) */',
        '  padding-block: 4px;',
        '  box-shadow: 0 2px 4px color-mix(in srgb, var(--dsw-alias-label-primary) 15%, transparent);',
        '}'
      ].join('\n')
