  ...
  factory: function () {
    ...
    function apply(ctx) {
      ...
      var CSS = [
        ...
        '}',
        ROWS + '.dsh-pinned{',
        '  /* a real, visible drop shadow below the row (the fade mask alone reads',
        '     as a hard edge on dsh flat background). clip-path keeps it below',
        '     only — a zero-x box-shadow would also bleed to the sides */',
