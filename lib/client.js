  ...
  factory: function () {
    ...
    function apply(ctx) {
      ...
      var CSS = [
        ...
        '  opacity: 0;',
        '  /* 80px: long enough to see the dissolve while scrolling (500px spread',
        '     the change too thin to notice, 24px flashed past) — and the band',
        '     starts slightly darker than the page bg so it is perceptible on',
        '     dsh flat background (pure bg-color fade is invisible there) */',
        '  background: linear-gradient(color-mix(in srgb, var(--dsw-alias-bg-base) 82%, #000), var(--dsw-alias-bg-base) 25%, transparent);',
        '  height: 80px;',
        '  position: absolute;',
        '  top: calc(100% - 1px);',
        '  right: 0;',
