  ...
  factory: function () {
    ...
    function apply(ctx) {
      ...
      var CSS = [
        ...
        '  opacity: 0;',
        '  position: absolute;',
        '  /* cover the row box + a long fade below: the label area is solid (no',
        '     content shows through behind the text), then a long, gentle dissolve',
        '     makes scrolled content melt away — that melting is the "shadow" look */',
        '  inset: 0 0 -48px 0;',
        '  right: 0;',
        '  transform: translateZ(0);',
        '  /* 82px total; row (34px) is ~41%. Solid until ~35% (label zone), then a',
        '     50px+ fade — long enough to read as a shadow, not a patch */',
