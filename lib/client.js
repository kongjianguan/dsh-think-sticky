  ...
  factory: function () {
    ...
    function apply(ctx) {
      ...
      var CSS = [
        ...
        '  opacity: 0;',
        '  position: absolute;',
        '  /* official curve: fully opaque at the top (label zone stays clean), then',
        '     a continuous fade to transparent — no solid/transparent boundary, so',
        '     scrolled content melts away instead of being hard-clipped */',
        '  inset: 0 0 -48px 0;',
        '  right: 0;',
