  ...
  factory: function () {
    ...
    function apply(ctx) {
      var CSS = [
        ...
        '  /* thicker pinned header: taller hit area + theme-aware drop shadow (no hard line) */',
        '  padding-block: 4px;',
        '  box-shadow: 0 2px 8px color-mix(in srgb, var(--dsw-alias-label-primary) 12%, transparent);',
        '}'
      ].join('\n')
